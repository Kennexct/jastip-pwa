    ...
    <div className="min-h-screen bg-[#F4F6FA]">
      ...
      <div className="bg-white px-5 pt-14 pb-5 border-b border-gray-100">
        <div className="flex items-center gap-3 mb-4">
          <button
            onClick={() => navigate("/")}
            className="w-9 h-9 rounded-xl bg-[#F4F6FA] flex items-center justify-center"
          >
          ...
          <button
            ...
            className="w-9 h-9 rounded-xl bg-[#2563EB] flex items-center justify-center"
          >
      ...
      <div className="px-5 py-4 space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            { label: "DP Pending", value: "5", color: "text-red-600" },
            { label: "DP Received", value: "7", color: "text-green-600" },
          ].map((s) => (
                ...
                <div className="p-4">
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <div className="flex items-center gap-1.5 mb-0.5">
                            ...
                            <span className="text-xs text-gray-400 font-medium">{item.customer}</span>
                          </div>
                          <p className="text-sm font-semibold text-gray-800 leading-tight">{item.item}</p>
                        </div>
                        <button className="w-7 h-7 rounded-lg bg-gray-50 flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-50 flex items-center justify-between">
                    ...
                    <span className="text-xs text-gray-400">
                      Received: <span className="font-semibold text-gray-600">{item.dpAmount}</span>
                    </span>
                  </div>
                </div>
              </motion.div>
            ...
            >
              ...
              <div className="px-5 pb-8 overflow-y-auto max-h-[85vh]">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    onClick={handleSave}
                    className={`w-full h-[52px] rounded-2xl font-semibold text-white transition-all flex items-center justify-center gap-2 ${
